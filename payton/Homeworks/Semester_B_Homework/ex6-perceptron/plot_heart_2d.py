...
def main():
    ...
    # הערה: במידה ויש שגיאת חיבור בגלל סינון, יש לוודא התקנת תעודת אבטחה
    ...
    # הערה: לפי מבנה הדאטה-סט הספציפי הזה, הערך '>50_1' מייצג נוכחות מחלה
    ...
    # הקוד שהוספנו להשלמת התרגיל:

    # נקודות עבור אלו ללא מחלת לב
    plt.scatter(x_vals[no_disease], y_vals[no_disease],
                color='#7294ac', label='No heart disease',
                alpha=0.8, edgecolors='white', s=40)

    # נקודות עבור אלו עם מחלת לב
    plt.scatter(x_vals[has_disease], y_vals[has_disease],
                color='#e88471', label='Heart disease',
                alpha=0.8, edgecolors='white', s=40)
